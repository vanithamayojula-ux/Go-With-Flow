...
export const WORLD_THEMES: WorldTheme[] = [
  ...
  {
    id: 'bleach-bypass-steel',
    name: 'Bleach Bypass Steel',
    skyColorTop: 0x070c14,
    skyColorBottom: 0x1e2736,
    fogColor: 0x101824,
    fogDensity: 0.009,
    ambientLightColor: 0x1a2433,
    ambientLightIntensity: 0.5,
    directionalLightColor: 0xff7722,
    directionalLightIntensity: 1.2,
    groundColor: 0x0b111a,
    trackColor: 0x16202e,
    laneLineColor: 0xffaa33,
    buildingColors: [0x0f1722, 0x182433, 0x0a1018],
    accentGlowColor: 0xff5500,
    particleType: 'embers',
    particleColor: 0xff7700,
    particleDensity: 1.4,
    portalColor: 0xff9900,
  },
  {
    id: 'meadow',
    name: 'Neon Meadow',
